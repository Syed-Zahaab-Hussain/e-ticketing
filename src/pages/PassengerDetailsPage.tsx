  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8">
          <Link 
            to={`/book/${bookingSummary.tripId}/seats?from=${encodeURIComponent(bookingSummary.from)}&to=${encodeURIComponent(bookingSummary.to)}&date=${encodeURIComponent(bookingSummary.date)}`}
